...
class RepeatHelloRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RepeatHelloRequest', package: const $pb.PackageName('helloworld'), createEmptyInstance: create)
    ..aOS(1, 'name')
    ..a<$core.int>(2, 'count', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  RepeatHelloRequest._() : super();
  factory RepeatHelloRequest() => create();
  factory RepeatHelloRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RepeatHelloRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  RepeatHelloRequest clone() => RepeatHelloRequest()..mergeFromMessage(this);
  RepeatHelloRequest copyWith(void Function(RepeatHelloRequest) updates) => super.copyWith((message) => updates(message as RepeatHelloRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static RepeatHelloRequest create() => RepeatHelloRequest._();
  RepeatHelloRequest createEmptyInstance() => create();
  static $pb.PbList<RepeatHelloRequest> createRepeated() => $pb.PbList<RepeatHelloRequest>();
  @$core.pragma('dart2js:noInline')
  static RepeatHelloRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RepeatHelloRequest>(create);
  static RepeatHelloRequest _defaultInstance;
